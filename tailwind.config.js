  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        addToCartHover: "url('/hoveraddtocart.svg')",
        addToCartdefault: "url('/AddToCart.svg')",
        clickaddtoCart: "url('/clickaddTocart.svg')",
        wishlistdefault: "url('/AddTowishlist.svg')",
        wishlisthover: "url('/clickwhishlist.svg')",
